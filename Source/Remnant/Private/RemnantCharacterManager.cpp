...
USavedCharacter* URemnantCharacterManager::GetCharacterInfo(APlayerController* Controller) {
    return NULL;
}
...
USavedCharacter* URemnantCharacterManager::CreateCharacter(const FString& Name, TSubclassOf<USavedCharacter> SaveGameClass, int32& ErrorCode, bool SetActive, ERemnantCharacterType CharacterType, bool ShouldSkipIntro, TSoftClassPtr<URemnantArchetype> Archetype, int32 StartingDifficulty) {
    return NULL;
}
